...
var InteractiveComponent = function (_Component) {
  ...
  function InteractiveComponent($el) {
    ...
    var _this = _possibleConstructorReturn(this, _Component.call(this, $el));
  ...
  InteractiveComponent.prototype.dispose = function dispose() {
    if (this.isMobile) {
  ...
  InteractiveComponent.prototype.handleTouchStart = function handleTouchStart(e) {
    if (e.touches[0]) {
  ...
  InteractiveComponent.prototype.handleTouchMove = function handleTouchMove(e) {
    if (e.touches[0]) {
  ...
  InteractiveComponent.prototype.handleToucheUp = function handleToucheUp(e) {
    this.$el.removeEventListener('touchmove', this.handleTouchMove);
    this.$el.removeEventListener('touchend', this.handleToucheUp);
